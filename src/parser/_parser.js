module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c25 = function(callee, args) {
            if (args) {
              return new ZB.FCallExpression(callee, args);
            }
            return callee;
          },
        peg$c26 = function(id) { return new ZB.Identifier(id); },
        peg$c27 = ";",
        ...
        peg$c37 = /^[a-fA-F]/,
        peg$c38 = { type: "class", value: "[a-fA-F]", description: "[a-fA-F]" },
        peg$c39 = "0x",
        peg$c40 = { type: "literal", value: "0x", description: "\"0x\"" },
        peg$c41 = /^[1-9a-fA-F]/,
        peg$c42 = { type: "class", value: "[1-9a-fA-F]", description: "[1-9a-fA-F]" },
        peg$c43 = function(hexStr) { return parseInt(hexStr, 16); },
        peg$c44 = "0",
        peg$c45 = { type: "literal", value: "0", description: "\"0\"" },
        peg$c46 = function() { return 0; },
        peg$c47 = /^[1-9]/,
        peg$c48 = { type: "class", value: "[1-9]", description: "[1-9]" },
        peg$c49 = function(str) { return parseInt(str, 10); },
        peg$c50 = function(i) { return new ZB.Literal(i, 'Int'); },
        peg$c51 = function(name, params, body) {
            return new ZB.FunctionDeclaration(name, params || [], body, null, null);
          },
        peg$c52 = void 0,
        peg$c53 = function(name) { return name; },
        peg$c54 = "using",
        peg$c55 = { type: "literal", value: "using", description: "\"using\"" },
        ...
        peg$c62 = function(alias, path, extraction) {
            return new ZB.Using(path, extraction ? extraction[1] : null);
          },
        peg$c63 = function(extractions) {
            return extractions;
          },
        ...
        peg$c70 = function() { error("Tabs aren't valid whitespace in Zoidberg"); },
        peg$c71 = /^[\n]/,
        peg$c72 = { type: "class", value: "[\\n]", description: "[\\n]" },
        peg$c73 = { type: "other", description: "end of line" },
        peg$c74 = "\n",
    ...
    function peg$parseImportExtractionList() {
      var s0, s1, s2, s3, s4, s5, s6, s7;
    ...
    function peg$parseImportExtraction() {
      var s0, s1, s2, s3, s4, s5;
      ...
      if (s1 !== peg$FAILED) {
        s2 = peg$parse__();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseImportExtractionList();
          if (s3 !== peg$FAILED) {
            s4 = peg$parse__();
            if (s4 !== peg$FAILED) {
              if (input.charCodeAt(peg$currPos) === 125) {
