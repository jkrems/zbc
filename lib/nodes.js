...
register(class BinaryExpression extends AstNode {
  constructor() { super([ 'op', 'left', 'right' ], arguments); }
});
...
register(class PropertyRead extends AstNode {
  constructor() { super([ 'base', 'field' ], arguments); }
});

register(class MethodCall extends AstNode {
  constructor() { super([ 'base', 'field', 'args' ], arguments); }
});
